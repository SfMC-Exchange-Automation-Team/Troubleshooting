...
| ----------------------- | ------------------------------------------------------ | ---------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------- |
| Outlook Desktop         | [outlook-desktop-client-connectivity-failure](https://github.com/SfMC-Exchange-Automation-Team/Troubleshooting/edit/main/Log%20Collection%20Guidelines%3A%20Exchange%20and%20Outlook%20Troubleshooting.md#outlook-desktop-client-connectivity-failure)           | Outlook shows **Disconnected** or cannot connect to mailbox      | Outlook troubleshooting logs                                           | Windows Explorer                                     |
